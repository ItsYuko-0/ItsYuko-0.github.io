...
const characterDescriptions = {
  "羽云": "羽云，妖族的成员，经常出没于妖之殿堂。性格温和但偶尔神秘，与世界各地的居民都有交集。",
  "镜晨": "精灵族的一员，常在精灵之殿活动。性格开朗，喜欢与人交流，但有时会突然消失。",
  "孤月": "活跃于塔顶观测室的神秘角色，消息量巨大，似乎对世界的一切都充满好奇。",
  "艾麗塔": "常出现在霜雅地区的角色，与北雨关系密切，性格可能较为内敛但重感情。",
  "涅索": "经常处于挂机状态的角色，但实际参与了大量场景。偏好雪堂茶馆和百花坛车站。",
  "克里托": "与闇关系密切的角色，活动范围广泛，从雪堂茶馆到黑色巢穴都有其踪迹。",
  "闇": "神秘的暗系角色，与克里托互动频繁。常出现在黑色巢穴和浣花溪小筑。",
